        ...
        Mat& K   )
{
    ...
    for (auto& i : points_3d) {
        ...
        vertex->setId(index++);
        vertex->setEstimate(Eigen::Vector3d(i.x, i.y, i.z));
    ...
    for (auto& i : points_2d) {
        ...
        edge->setMeasurement(Eigen::Vector2d(i.x, i.y));
        edge->setParameterId(0, 0);
//        edge->setRobustKernel(reinterpret_cast<g2o::RobustKernel*>(g2o::RobustKernelPtr));
